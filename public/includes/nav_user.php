...
<aside class="sidebar">
    ...
    <a href="/public/usuario/dashboard_user.php" class="sidebar-logo">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="/public/usuario/cardapio/cardapio.php" class="sidebar-link">
            <i class="fa-solid fa-bag-shopping"></i> Cardápio
        </a>

        <a href="/public/usuario/carrinho/carrinho.php" class="sidebar-link">
            <i class="fa-solid fa-cart-shopping"></i> Meu Carrinho
        </a>

        <a href="/public/usuario/avaliacoes/avaliacoes.php" class="sidebar-link">
            <i class="fa-regular fa-star"></i> Avaliações
        </a>

        <a href="/public/usuario/historico/historico.php" class="sidebar-link">
            <i class="fa-solid fa-clock"></i> Pedidos
        </a>

        <span class="sidebar-grupo">Conta</span>

        <a href="/public/usuario/perfil/perfilU.php" class="sidebar-link">

...
<div class="dash-user-page">
    ...
    <div class="dash-grid">
        ...
        <a href="pedidos/carrinho.php" class="dash-card" data-n="02">
        ...
        <a href="pedidos/historico.php" class="dash-card" data-n="03">
        ...
        <a href="favoritos/favoritos.php" class="dash-card" data-n="06">

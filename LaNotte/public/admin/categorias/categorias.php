    ...
    <div>
        <div class="main">
            ...
            <div class="page-header">
                ...
                <a href="/public/admin/categorias/addA.php" class="add">
            ...
            <div class="cats-grid">
                    <?php foreach ($categorias as $categoria): ?>
                        <div class="cat-card" data-id="<?= $categoria['id'] ?>">
                            ...
                            <div class="cat-acoes">
                                <a href="/public/admin/categorias/editarA.php?id=<?= $categoria['id'] ?>" class="btn-editar">
                                    <i class="fa-solid fa-pen"></i> Editar
                                </a>
                                <a href="/public/admin/categorias/deleteA.php?id=<?= $categoria['id'] ?>"
                                    class="btn-deletar"

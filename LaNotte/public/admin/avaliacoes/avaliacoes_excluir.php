...
if (isset($_GET['excluir'])) {
    ...
    header('Location: /public/admin/avaliacoes/avaliacoes_excluir.php');
    exit();
}
                ...
                <?php foreach ($avaliacoes as $avaliacao): ?>
                    <div class="avaliacao-card">
                        <div class="avaliacao-topo">
                            <img src="/public/images/<?= !empty($avaliacao['user_img']) ? $avaliacao['user_img'] : 'semfoto.jpg' ?>" alt="<?= $avaliacao['user_nome'] ?>" class="avaliacao-avatar">
                        ...
                        <div class="avaliacao-acoes">
                            <a href="/public/admin/avaliacoes/avaliacoes_excluir.php?excluir=<?= $avaliacao['review_id'] ?>"

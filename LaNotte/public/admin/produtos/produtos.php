...
<div class="main">
    <div class="page-header">
        ...
        <a href="/public/admin/produtos/addP.php" class="add">
            ...
            <tbody>
                    <?php foreach ($produtos as $produto): ?>
                        <tr>
                            ...
                            <td>
                                <div class="td-acoes">
                                    <a href="/public/admin/produtos/editarP.php?id=<?= $produto['id'] ?>" class="btn-editar">
                                        <i class="fa-solid fa-pen"></i> Editar
                                    </a>
                                    <a href="/public/admin/produtos/deleteP.php?id=<?= $produto['id'] ?>"
                                       class="btn-deletar"

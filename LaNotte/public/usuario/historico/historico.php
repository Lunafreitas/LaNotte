...
$stmt = $pdo->prepare('SELECT * FROM pedidos WHERE user_id = :user_id ORDER BY id DESC LIMIT 10');
...
<body class="user">
    ...
    <?php if ($count_pedidos === 0): ?>
        <div class="carrinho-vazio">
            ...
            <a href="/public/usuario/cardapio/cardapio.php" class="btn-voltar-cardapio">

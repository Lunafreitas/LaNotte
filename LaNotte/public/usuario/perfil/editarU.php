...
if (!isset($_GET['id'])) {
    header('Location: /public/usuario/perfil/perfilU.php');
    exit();
}
...
<div class="editar-page">
    <div class="editar-card-topo">
        ...
        <img src="/public/images/<?= $imagemAtual ?>"alt="Foto de perfil" class="perfil-avatar">
    ...
    <div class="editar-card-form">
        ...
        <form method="post"
            action="/public/usuario/perfil/editarU.php?id=<?= urlencode($id) ?>"
        ...
        <div class="editar-acoes">
            ...
            <a href="/public/usuario/perfil/perfilU.php" class="btn-voltar-perfil">
